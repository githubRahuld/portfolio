...
function Home() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setLoading(false);
        // console.log(res.data.user.services[0].image.url);
        // console.log(res.data.user.about);
        setUserData(res.data);
        setServices(res.data.user);
      })
  ...
  return (
    <>
        ...
        <div className="flex justify-between items-center backdrop-blur-sm bg-stone-100  p-6 shadow-md pb-24 pt-24">
          <div className="w-2/4 pr-6 pl-10">
            ...
            <div className="flex flex-row space-x-4 pt-10 ">
              ...
              <SocialImg src="/img/socialMedia/linkedin.webp" text="LinkedIn" />
      ...
      {/* About Section*/}
      <section id="services">
        <div className="flex flex-col shadow-xl text-black rounded-none pt-24 pb-24 bg-white">
          <div>
